...
export const UseAISummarizePage = () => {
    ...
    const [context, setContext] = useState<string>("don't use the article title in the summary and always end with 'Powered by react-tools'")
            ...
            <article>
                ...
                {activeTab === 'options' && (
                    <section>
                        ...
                        <div className="grid">
                            ...
                            <div>
                                <label htmlFor="outputLanguage" data-tooltip="Output language: en (English), es (Spanish), ja (Japanese)">
                                    Output Language
                                </label>
                                <select
                                    id="outputLanguage"
                                    value={options.outputLanguage}
                                    onChange={(e) => setOptions({ ...options, outputLanguage: e.target.value as UseAISummarizeOptions['outputLanguage'] })}
                                >
                ...
                {activeTab === 'input' && (
                    <section>
                        ...
                        <label htmlFor="context" data-tooltip="Additional context to guide the summarization (e.g., 'This article is intended for a tech-savvy audience')">
                            Context (optional)
                        </label>
                        <textarea
                            id="context"
                            ...
                            placeholder="Enter additional context for the summary..."
                            rows={2}
                        />
                    </section>
                )}
