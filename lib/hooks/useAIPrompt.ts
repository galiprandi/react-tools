 ...
 *
 * @warning Streaming behavior: The Chrome Prompt API returns cumulative chunks.
 * This hook replaces the current state with the latest chunk to avoid DoS.
 * Do not manually concatenate chunks.
 *
 * @example
 * ```tsx
